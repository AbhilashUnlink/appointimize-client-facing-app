        ...
        <div className="bg-gray-950 rounded-lg">
          ...
          >
            <div className="border-b border-b-white/10 pb-5">
              <h2 className="text-lg font-medium uppercase leading-7">
                Registration Form
              </h2>
                        ...
                        <div className="flex flex-col items-center text-center">
                          ...
                          <div className="mt-4 flex items-center mb-1 text-sm leading-6 text-gray-400">
                            <label htmlFor="file-upload">
                              <span className="relative cursor-pointer rounded-md px-2 py-1 bg-gray-900 font-medium text-gray-200 hover:bg-gray-800">
                                Upload a file
                              </span>
                              <input
                                type="file"
            ...
            {errMsg && (
              <p className="bg-white/90 text-red-600 text-center py-1 rounded-md tracking-wide font-medium">
                {errMsg}
              </p>
            )}
            <button
          ...
          <p className="text-sm leading-6 text-gray-400 text-center -mt-2 py-10">
            ...
            <button
              ...
              className="text-gray-200 font-medium underline underline-offset-2 decoration-[1px] hover:text-white duration-200"
            >
              Login
            </button>
          </p>
